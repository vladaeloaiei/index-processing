...
public class WebDocumentSubjectRepository implements Serializable {
    private static final String COLLECTION_KEY = "collection";

    private ObjectMapper objectMapper = new ObjectMapper();

    public String getCollectionName() {
        return WebDocumentSubject.COLLECTION_NAME;
    }

    public void save(JavaSparkContext javaSparkContext, JavaRDD<WebDocumentSubject> rdd) {
