...
public class WebTitleRepository implements Serializable {
    private static final String COLLECTION_KEY = "collection";

    private ObjectMapper objectMapper = new ObjectMapper();

    public String getCollectionName() {
        return WebTitle.COLLECTION_NAME;
    }

    public void save(JavaSparkContext javaSparkContext, JavaRDD<WebTitle> rdd) {
