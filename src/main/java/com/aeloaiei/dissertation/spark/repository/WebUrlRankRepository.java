...
public class WebUrlRankRepository implements Serializable {
    private static final String COLLECTION_KEY = "collection";

    private ObjectMapper objectMapper = new ObjectMapper();

    public String getCollectionName() {
        return WebUrlRank.COLLECTION_NAME;
    }

    public void save(JavaSparkContext javaSparkContext, JavaRDD<WebUrlRank> rdd) {
